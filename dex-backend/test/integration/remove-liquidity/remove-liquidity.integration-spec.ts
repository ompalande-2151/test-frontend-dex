...
import { RemoveLiquidityModule } from '../../../src/modules/remove-liquidity/remove-liquidity.module';

jest.setTimeout(60000);

describe('Remove Liquidity Integration', () => {
  ...
  describe('POST /remove-liquidity', () => {
    ...
    it('should reduce pool reserves', async () => {
      ...
      expect(response.body.currentToken0Amount).toBe('800');

      expect(response.body.currentToken1Amount).toBe('1500');
    });
  ...
  describe('GET /remove-liquidity/:poolAddress', () => {
    it('should return remove liquidity transactions', async () => {
      const response = await request(app.getHttpServer()).get(
        '/remove-liquidity/0x1111111111111111111111111111111111111111',
      );
    ...
    it('should return empty array for pool with no remove liquidity history', async () => {
      const response = await request(app.getHttpServer()).get(
        '/remove-liquidity/0x9999999999999999999999999999999999999999',
      );
